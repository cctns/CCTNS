...
<html lang="en">
  <head>
    ...
    <!-- Le styles -->
    <link href="<? echo base_url()?>_assets/bootstrap/css/bootstrap.css" rel="stylesheet">
    <style type="textcss">
      body {
        padding-top: 60px;
        padding-bottom: 40px;
    ...
    <link href="<? echo base_url()?>_assets/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">
